...
% Last Modified by GUIDE v2.5 16-Jun-2018 03:29:52

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...3
...
% Mostrar el logo logo_ipn.png
ipn = imread('logo_ipn.jpg');
axes(handles.axes_ipn);
imshow(ipn);

% Mostar el logo logo_escom.png
escom = imread('logo_escom.jpg');
axes(handles.axes_escom);
imshow(escom);
...
% --- Executes on button press in btn_comenzar.
function btn_comenzar_Callback(hObject, eventdata, handles)
% hObject    handle to btn_comenzar (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
menu_principal
